#
#  Be sure to run `pod spec lint DTOkyc.podspec' to ensure this is a
...
DTOkyc is for doing offline-kyc. It is same like doing in UIDAI website
                   DESC

  spec.homepage     = "https://github.com/DigiTapAi/DTOkyc"
  ...
  spec.source       = { :git => "https://github.com/DigiTapAi/DTOkyc.git", :tag => spec.version.to_s }
  ...
  # Instead of `resources`, use `resource_bundles` to avoid conflicts
  spec.resource_bundles = {
    'DTOkycResources' => 'DTOkyc.xcframework/**/*.bundle'
  }  
